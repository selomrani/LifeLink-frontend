        ...
        <main class="max-w-2xl mx-auto pt-6 px-4 space-y-6">
            ...
            <div v-else class="space-y-6">
                <article class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-5 sm:px-6 py-4 flex items-center justify-between border-t border-gray-100 bg-gray-50/50">
                    ...
                    <div class="p-4 sm:p-5 bg-white border-t border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <button :disabled="post.status === 'completed'" @click="showToast('Thank you for offering to donate blood!')"
                        ...
                        <div class="flex gap-3">
                            <button type="button" @click="openSupportModal"
                            ...
                            <button type="button" title="Share" @click="showToast('Link copied to clipboard!')"
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="p-5 sm:px-6 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                        <h3 class="font-bold text-gray-900 flex items-center gap-2.5 text-lg">
                            Comments
                            <span class="bg-gray-200 text-gray-700 py-0.5 px-2.5 rounded-full text-xs font-bold">{{ post.comments?.length || 0 }}</span>
                        </h3>
                    </div>
